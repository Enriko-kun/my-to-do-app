      ...
      <div className='bg-white p-3 max-w-md mx-auto'>
        <div className='text-center'>
          ...
          <div className='mt-4 flex'>
            <input className='w-80 border-b-2 border-gray-500 text-black' type='text' placeholder='Enter your task here' />
          ...
          <ul>
            <li className='p-2 rounded-lg'>
              <div className='flex align-middle flex-row justify-between'>
                ...
                <button className='flex text-red-500 border-2 border-red-500 p-2 rounded-lg hover:text-white hover:bg-red-500'>
                  <svg className='h-6 w-6' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' strokeLinecap='round' strokeLinejoin='round'> <circle cx='12' cy='12' r='10'/> <line x1='15' y1='9' x2='9' y2='15'/> <line x1='9' y1='9' x2='15' y2='15'/></svg>
                  <span>Remove</span>
                </button>
              </div>
              <hr className='mt-2' />
            ...
            <li className='p-2 rounded-lg'>
              <div className='flex align-middle flex-row justify-between'>
                ...
                <div className='p-2'>
                  <p className='text-lg text-black'>Wash Dish</p>
                </div>
                <button className='flex text-red-500 border-2 border-red-500 p-2 rounded-lg hover:text-white hover:bg-red-500'>
                  <svg className='h-6 w-6' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' strokeLinecap='round' strokeLinejoin='round'> <circle cx='12' cy='12' r='10'/> <line x1='15' y1='9' x2='9' y2='15'/> <line x1='9' y1='9' x2='15' y2='15'/></svg>
                  <span>Remove</span>
        ...
        <div className='mt-8'>
          <button className='border-2 border-red-500 p-2 text-red-500'>Clear Completed Task</button>
          <button className='border-2 border-indigo-500 p-2 text-indigo-500 ml-4'>Reset ToDo List</button>
        </div>
      </div>
    </div>
  )
